              ...
              $(".email").on("input",function(){
                  ...
                  if ($(this).val() == "")
                      ...
                      if (checkEmail($(this).val()))
                          $(".email").css({backgroundColor:"green",color:"white"});
                      else
                          $(".email").css({backgroundColor:"red",color:"white"});
                  }
              })
    ...
    $(document).ready(function(){
              ...
              $(".phone").on("input",function(){
                  ...
                  if ($(this).val() == "")
                      ...
                      if (checkEmail($(this).val()))
                          $(".phone").css({backgroundColor:"green",color:"white"});
                      else
                          $(".phone").css({backgroundColor:"red",color:"white"});
                  }
              })
...
function validation(){
    ...
    var cnamechk =/^[A-za-z. ]{3,30}$/;
    var emailchk = /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/;
    var mobchk = /^[789][0-9]{9}/;

    if(namechk.test(name)){
        document.getElementById("nameerror").innerHTML =" ";
    }else{
        document.getElementById("nameerror").innerHTML ="Please Enter Your Name Here ";
        return false; 
        document.getElementById("myTextarea").disabled = true;  
    }

    if(cnamechk.test(Cname)){
        document.getElementById("cnameerror").innerHTML =" ";
    }else{
        document.getElementById("cnameerror").innerHTML ="Please Enter Company Name Here ";
        return false;   
    }
    ...
    if(emailchk.test(email)){
        ...
        document.getElementById("emailerror").innerHTML ="Please Enter Proper EmailId";
        return false;   
    }
    if(mobchk.test(phone)){
        document.getElementById("phoneerror").innerHTML =" ";
    }else{
        document.getElementById("phoneerror").innerHTML ="Please Enter Correct Mobile Number";
        return false;   
    }
...
//     Email.send({
//     Host : "smtp.gmail.com",
//     Username : "dockercontainer1234@gmail.com",
//     Password : "Docker@123",
//     To : 'saurabh.nik97@gmail.com',
//     From : inputs.elements["email"].value,
//     Subject : "New email submitted",
//     Body :inputs.elements["message"].value + "<br>" + inputs.elements["name"].value +"<br>" + inputs.elements["Cname"].value + "<br>" + inputs.elements["phone"].value
// }).then(
...
//     var ptrn /^[a-zA-Z ]{2,30}$/
//     if(ptrn.test(document.myForm.name)){
